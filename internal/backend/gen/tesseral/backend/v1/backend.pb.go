...
var file_tesseral_backend_v1_backend_proto_rawDesc = string([]byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x32, 0xb9, 0x46, 0x0a, 0x0e, 0x42, 0x61,
	...
	0x6b, 0x65, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x87, 0x01, 0x0a, 0x18,
	0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x74, 0x72, 0x69, 0x70, 0x65, 0x43, 0x68, 0x65, 0x63,
	0x6b, 0x6f, 0x75, 0x74, 0x4c, 0x69, 0x6e, 0x6b, 0x12, 0x34, 0x2e, 0x74, 0x65, 0x73, 0x73, 0x65,
	0x72, 0x61, 0x6c, 0x2e, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x2e, 0x76, 0x31, 0x2e, 0x43,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x74, 0x72, 0x69, 0x70, 0x65, 0x43, 0x68, 0x65, 0x63, 0x6b,
	0x6f, 0x75, 0x74, 0x4c, 0x69, 0x6e, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x35,
	0x2e, 0x74, 0x65, 0x73, 0x73, 0x65, 0x72, 0x61, 0x6c, 0x2e, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e,
...
var file_tesseral_backend_v1_backend_proto_msgTypes = make([]protoimpl.MessageInfo, 125)
var file_tesseral_backend_v1_backend_proto_goTypes = []any{
	...
	(*CreateStripeCheckoutLinkRequest)(nil),               // 123: tesseral.backend.v1.CreateStripeCheckoutLinkRequest
	(*CreateStripeCheckoutLinkResponse)(nil),              // 124: tesseral.backend.v1.CreateStripeCheckoutLinkResponse
	(*Project)(nil),                                       // 125: tesseral.backend.v1.Project
	(*Organization)(nil),                                  // 126: tesseral.backend.v1.Organization
	(*OrganizationDomains)(nil),                           // 127: tesseral.backend.v1.OrganizationDomains
	(*OrganizationGoogleHostedDomains)(nil),               // 128: tesseral.backend.v1.OrganizationGoogleHostedDomains
	(*OrganizationMicrosoftTenantIDs)(nil),                // 129: tesseral.backend.v1.OrganizationMicrosoftTenantIDs
	(*SAMLConnection)(nil),                                // 130: tesseral.backend.v1.SAMLConnection
	(*SCIMAPIKey)(nil),                                    // 131: tesseral.backend.v1.SCIMAPIKey
	(*User)(nil),                                          // 132: tesseral.backend.v1.User
	(*Passkey)(nil),                                       // 133: tesseral.backend.v1.Passkey
	(*Session)(nil),                                       // 134: tesseral.backend.v1.Session
	(*UserInvite)(nil),                                    // 135: tesseral.backend.v1.UserInvite
	(*BackendAPIKey)(nil),                                 // 136: tesseral.backend.v1.BackendAPIKey
	(*VaultDomainSettings)(nil),                           // 137: tesseral.backend.v1.VaultDomainSettings
	(*PublishableKey)(nil),                                // 138: tesseral.backend.v1.PublishableKey
	(*ProjectUISettings)(nil),                             // 139: tesseral.backend.v1.ProjectUISettings
	(*timestamppb.Timestamp)(nil),                         // 140: google.protobuf.Timestamp
	(*UserImpersonationToken)(nil),                        // 141: tesseral.backend.v1.UserImpersonationToken
}
var file_tesseral_backend_v1_backend_proto_depIdxs = []int32{
	125, // 0: tesseral.backend.v1.GetProjectResponse.project:type_name -> tesseral.backend.v1.Project
	125, // 1: tesseral.backend.v1.UpdateProjectRequest.project:type_name -> tesseral.backend.v1.Project
	125, // 2: tesseral.backend.v1.UpdateProjectResponse.project:type_name -> tesseral.backend.v1.Project
	126, // 3: tesseral.backend.v1.ListOrganizationsResponse.organizations:type_name -> tesseral.backend.v1.Organization
	126, // 4: tesseral.backend.v1.GetOrganizationResponse.organization:type_name -> tesseral.backend.v1.Organization
	126, // 5: tesseral.backend.v1.CreateOrganizationRequest.organization:type_name -> tesseral.backend.v1.Organization
	126, // 6: tesseral.backend.v1.CreateOrganizationResponse.organization:type_name -> tesseral.backend.v1.Organization
	126, // 7: tesseral.backend.v1.UpdateOrganizationRequest.organization:type_name -> tesseral.backend.v1.Organization
	126, // 8: tesseral.backend.v1.UpdateOrganizationResponse.organization:type_name -> tesseral.backend.v1.Organization
	127, // 9: tesseral.backend.v1.GetOrganizationDomainsResponse.organization_domains:type_name -> tesseral.backend.v1.OrganizationDomains
	127, // 10: tesseral.backend.v1.UpdateOrganizationDomainsRequest.organization_domains:type_name -> tesseral.backend.v1.OrganizationDomains
	127, // 11: tesseral.backend.v1.UpdateOrganizationDomainsResponse.organization_domains:type_name -> tesseral.backend.v1.OrganizationDomains
	128, // 12: tesseral.backend.v1.GetOrganizationGoogleHostedDomainsResponse.organization_google_hosted_domains:type_name -> tesseral.backend.v1.OrganizationGoogleHostedDomains
	128, // 13: tesseral.backend.v1.UpdateOrganizationGoogleHostedDomainsRequest.organization_google_hosted_domains:type_name -> tesseral.backend.v1.OrganizationGoogleHostedDomains
	128, // 14: tesseral.backend.v1.UpdateOrganizationGoogleHostedDomainsResponse.organization_google_hosted_domains:type_name -> tesseral.backend.v1.OrganizationGoogleHostedDomains
	129, // 15: tesseral.backend.v1.GetOrganizationMicrosoftTenantIDsResponse.organization_microsoft_tenant_ids:type_name -> tesseral.backend.v1.OrganizationMicrosoftTenantIDs
	129, // 16: tesseral.backend.v1.UpdateOrganizationMicrosoftTenantIDsRequest.organization_microsoft_tenant_ids:type_name -> tesseral.backend.v1.OrganizationMicrosoftTenantIDs
	129, // 17: tesseral.backend.v1.UpdateOrganizationMicrosoftTenantIDsResponse.organization_microsoft_tenant_ids:type_name -> tesseral.backend.v1.OrganizationMicrosoftTenantIDs
	130, // 18: tesseral.backend.v1.ListSAMLConnectionsResponse.saml_connections:type_name -> tesseral.backend.v1.SAMLConnection
	130, // 19: tesseral.backend.v1.GetSAMLConnectionResponse.saml_connection:type_name -> tesseral.backend.v1.SAMLConnection
	130, // 20: tesseral.backend.v1.CreateSAMLConnectionRequest.saml_connection:type_name -> tesseral.backend.v1.SAMLConnection
	130, // 21: tesseral.backend.v1.CreateSAMLConnectionResponse.saml_connection:type_name -> tesseral.backend.v1.SAMLConnection
	130, // 22: tesseral.backend.v1.UpdateSAMLConnectionRequest.saml_connection:type_name -> tesseral.backend.v1.SAMLConnection
	130, // 23: tesseral.backend.v1.UpdateSAMLConnectionResponse.saml_connection:type_name -> tesseral.backend.v1.SAMLConnection
	131, // 24: tesseral.backend.v1.ListSCIMAPIKeysResponse.scim_api_keys:type_name -> tesseral.backend.v1.SCIMAPIKey
	131, // 25: tesseral.backend.v1.GetSCIMAPIKeyResponse.scim_api_key:type_name -> tesseral.backend.v1.SCIMAPIKey
	131, // 26: tesseral.backend.v1.CreateSCIMAPIKeyRequest.scim_api_key:type_name -> tesseral.backend.v1.SCIMAPIKey
	131, // 27: tesseral.backend.v1.CreateSCIMAPIKeyResponse.scim_api_key:type_name -> tesseral.backend.v1.SCIMAPIKey
	131, // 28: tesseral.backend.v1.UpdateSCIMAPIKeyRequest.scim_api_key:type_name -> tesseral.backend.v1.SCIMAPIKey
	131, // 29: tesseral.backend.v1.UpdateSCIMAPIKeyResponse.scim_api_key:type_name -> tesseral.backend.v1.SCIMAPIKey
	131, // 30: tesseral.backend.v1.RevokeSCIMAPIKeyResponse.scim_api_key:type_name -> tesseral.backend.v1.SCIMAPIKey
	132, // 31: tesseral.backend.v1.ListUsersResponse.users:type_name -> tesseral.backend.v1.User
	132, // 32: tesseral.backend.v1.GetUserResponse.user:type_name -> tesseral.backend.v1.User
	132, // 33: tesseral.backend.v1.CreateUserRequest.user:type_name -> tesseral.backend.v1.User
	132, // 34: tesseral.backend.v1.CreateUserResponse.user:type_name -> tesseral.backend.v1.User
	132, // 35: tesseral.backend.v1.UpdateUserRequest.user:type_name -> tesseral.backend.v1.User
	132, // 36: tesseral.backend.v1.UpdateUserResponse.user:type_name -> tesseral.backend.v1.User
	133, // 37: tesseral.backend.v1.ListPasskeysResponse.passkeys:type_name -> tesseral.backend.v1.Passkey
	133, // 38: tesseral.backend.v1.GetPasskeyResponse.passkey:type_name -> tesseral.backend.v1.Passkey
	133, // 39: tesseral.backend.v1.UpdatePasskeyRequest.passkey:type_name -> tesseral.backend.v1.Passkey
	133, // 40: tesseral.backend.v1.UpdatePasskeyResponse.passkey:type_name -> tesseral.backend.v1.Passkey
	134, // 41: tesseral.backend.v1.ListSessionsResponse.sessions:type_name -> tesseral.backend.v1.Session
	134, // 42: tesseral.backend.v1.GetSessionResponse.session:type_name -> tesseral.backend.v1.Session
	135, // 43: tesseral.backend.v1.ListUserInvitesResponse.user_invites:type_name -> tesseral.backend.v1.UserInvite
	135, // 44: tesseral.backend.v1.GetUserInviteResponse.user_invite:type_name -> tesseral.backend.v1.UserInvite
	135, // 45: tesseral.backend.v1.CreateUserInviteRequest.user_invite:type_name -> tesseral.backend.v1.UserInvite
	135, // 46: tesseral.backend.v1.CreateUserInviteResponse.user_invite:type_name -> tesseral.backend.v1.UserInvite
	136, // 47: tesseral.backend.v1.ListBackendAPIKeysResponse.backend_api_keys:type_name -> tesseral.backend.v1.BackendAPIKey
	136, // 48: tesseral.backend.v1.GetBackendAPIKeyResponse.backend_api_key:type_name -> tesseral.backend.v1.BackendAPIKey
	136, // 49: tesseral.backend.v1.CreateBackendAPIKeyRequest.backend_api_key:type_name -> tesseral.backend.v1.BackendAPIKey
	136, // 50: tesseral.backend.v1.CreateBackendAPIKeyResponse.backend_api_key:type_name -> tesseral.backend.v1.BackendAPIKey
	136, // 51: tesseral.backend.v1.UpdateBackendAPIKeyRequest.backend_api_key:type_name -> tesseral.backend.v1.BackendAPIKey
	136, // 52: tesseral.backend.v1.UpdateBackendAPIKeyResponse.backend_api_key:type_name -> tesseral.backend.v1.BackendAPIKey
	136, // 53: tesseral.backend.v1.RevokeBackendAPIKeyResponse.backend_api_key:type_name -> tesseral.backend.v1.BackendAPIKey
	137, // 54: tesseral.backend.v1.GetVaultDomainSettingsResponse.vault_domain_settings:type_name -> tesseral.backend.v1.VaultDomainSettings
	137, // 55: tesseral.backend.v1.UpdateVaultDomainSettingsRequest.vault_domain_settings:type_name -> tesseral.backend.v1.VaultDomainSettings
	137, // 56: tesseral.backend.v1.UpdateVaultDomainSettingsResponse.vault_domain_settings:type_name -> tesseral.backend.v1.VaultDomainSettings
	138, // 57: tesseral.backend.v1.ListPublishableKeysResponse.publishable_keys:type_name -> tesseral.backend.v1.PublishableKey
	138, // 58: tesseral.backend.v1.GetPublishableKeyResponse.publishable_key:type_name -> tesseral.backend.v1.PublishableKey
	138, // 59: tesseral.backend.v1.CreatePublishableKeyRequest.publishable_key:type_name -> tesseral.backend.v1.PublishableKey
	138, // 60: tesseral.backend.v1.CreatePublishableKeyResponse.publishable_key:type_name -> tesseral.backend.v1.PublishableKey
	138, // 61: tesseral.backend.v1.UpdatePublishableKeyRequest.publishable_key:type_name -> tesseral.backend.v1.PublishableKey
	138, // 62: tesseral.backend.v1.UpdatePublishableKeyResponse.publishable_key:type_name -> tesseral.backend.v1.PublishableKey
	139, // 63: tesseral.backend.v1.GetProjectUISettingsResponse.project_ui_settings:type_name -> tesseral.backend.v1.ProjectUISettings
	140, // 64: tesseral.backend.v1.UpdateProjectUISettingsResponse.create_time:type_name -> google.protobuf.Timestamp
	140, // 65: tesseral.backend.v1.UpdateProjectUISettingsResponse.update_time:type_name -> google.protobuf.Timestamp
	141, // 66: tesseral.backend.v1.CreateUserImpersonationTokenRequest.user_impersonation_token:type_name -> tesseral.backend.v1.UserImpersonationToken
	141, // 67: tesseral.backend.v1.CreateUserImpersonationTokenResponse.user_impersonation_token:type_name -> tesseral.backend.v1.UserImpersonationToken
	...
	123, // 129: tesseral.backend.v1.BackendService.CreateStripeCheckoutLink:input_type -> tesseral.backend.v1.CreateStripeCheckoutLinkRequest
	1,   // 130: tesseral.backend.v1.BackendService.GetProject:output_type -> tesseral.backend.v1.GetProjectResponse
	5,   // 131: tesseral.backend.v1.BackendService.ListOrganizations:output_type -> tesseral.backend.v1.ListOrganizationsResponse
	7,   // 132: tesseral.backend.v1.BackendService.GetOrganization:output_type -> tesseral.backend.v1.GetOrganizationResponse
	9,   // 133: tesseral.backend.v1.BackendService.CreateOrganization:output_type -> tesseral.backend.v1.CreateOrganizationResponse
	11,  // 134: tesseral.backend.v1.BackendService.UpdateOrganization:output_type -> tesseral.backend.v1.UpdateOrganizationResponse
	13,  // 135: tesseral.backend.v1.BackendService.DeleteOrganization:output_type -> tesseral.backend.v1.DeleteOrganizationResponse
	15,  // 136: tesseral.backend.v1.BackendService.GetOrganizationDomains:output_type -> tesseral.backend.v1.GetOrganizationDomainsResponse
	17,  // 137: tesseral.backend.v1.BackendService.UpdateOrganizationDomains:output_type -> tesseral.backend.v1.UpdateOrganizationDomainsResponse
	19,  // 138: tesseral.backend.v1.BackendService.GetOrganizationGoogleHostedDomains:output_type -> tesseral.backend.v1.GetOrganizationGoogleHostedDomainsResponse
	21,  // 139: tesseral.backend.v1.BackendService.UpdateOrganizationGoogleHostedDomains:output_type -> tesseral.backend.v1.UpdateOrganizationGoogleHostedDomainsResponse
	23,  // 140: tesseral.backend.v1.BackendService.GetOrganizationMicrosoftTenantIDs:output_type -> tesseral.backend.v1.GetOrganizationMicrosoftTenantIDsResponse
	25,  // 141: tesseral.backend.v1.BackendService.UpdateOrganizationMicrosoftTenantIDs:output_type -> tesseral.backend.v1.UpdateOrganizationMicrosoftTenantIDsResponse
	27,  // 142: tesseral.backend.v1.BackendService.ListSAMLConnections:output_type -> tesseral.backend.v1.ListSAMLConnectionsResponse
	29,  // 143: tesseral.backend.v1.BackendService.GetSAMLConnection:output_type -> tesseral.backend.v1.GetSAMLConnectionResponse
	31,  // 144: tesseral.backend.v1.BackendService.CreateSAMLConnection:output_type -> tesseral.backend.v1.CreateSAMLConnectionResponse
	33,  // 145: tesseral.backend.v1.BackendService.UpdateSAMLConnection:output_type -> tesseral.backend.v1.UpdateSAMLConnectionResponse
	35,  // 146: tesseral.backend.v1.BackendService.DeleteSAMLConnection:output_type -> tesseral.backend.v1.DeleteSAMLConnectionResponse
	37,  // 147: tesseral.backend.v1.BackendService.ListSCIMAPIKeys:output_type -> tesseral.backend.v1.ListSCIMAPIKeysResponse
	39,  // 148: tesseral.backend.v1.BackendService.GetSCIMAPIKey:output_type -> tesseral.backend.v1.GetSCIMAPIKeyResponse
	41,  // 149: tesseral.backend.v1.BackendService.CreateSCIMAPIKey:output_type -> tesseral.backend.v1.CreateSCIMAPIKeyResponse
	43,  // 150: tesseral.backend.v1.BackendService.UpdateSCIMAPIKey:output_type -> tesseral.backend.v1.UpdateSCIMAPIKeyResponse
	45,  // 151: tesseral.backend.v1.BackendService.DeleteSCIMAPIKey:output_type -> tesseral.backend.v1.DeleteSCIMAPIKeyResponse
	47,  // 152: tesseral.backend.v1.BackendService.RevokeSCIMAPIKey:output_type -> tesseral.backend.v1.RevokeSCIMAPIKeyResponse
	49,  // 153: tesseral.backend.v1.BackendService.ListUsers:output_type -> tesseral.backend.v1.ListUsersResponse
	51,  // 154: tesseral.backend.v1.BackendService.GetUser:output_type -> tesseral.backend.v1.GetUserResponse
	53,  // 155: tesseral.backend.v1.BackendService.CreateUser:output_type -> tesseral.backend.v1.CreateUserResponse
	55,  // 156: tesseral.backend.v1.BackendService.UpdateUser:output_type -> tesseral.backend.v1.UpdateUserResponse
	57,  // 157: tesseral.backend.v1.BackendService.DeleteUser:output_type -> tesseral.backend.v1.DeleteUserResponse
	59,  // 158: tesseral.backend.v1.BackendService.ListPasskeys:output_type -> tesseral.backend.v1.ListPasskeysResponse
	61,  // 159: tesseral.backend.v1.BackendService.GetPasskey:output_type -> tesseral.backend.v1.GetPasskeyResponse
	63,  // 160: tesseral.backend.v1.BackendService.UpdatePasskey:output_type -> tesseral.backend.v1.UpdatePasskeyResponse
	65,  // 161: tesseral.backend.v1.BackendService.DeletePasskey:output_type -> tesseral.backend.v1.DeletePasskeyResponse
	67,  // 162: tesseral.backend.v1.BackendService.ListSessions:output_type -> tesseral.backend.v1.ListSessionsResponse
	69,  // 163: tesseral.backend.v1.BackendService.GetSession:output_type -> tesseral.backend.v1.GetSessionResponse
	71,  // 164: tesseral.backend.v1.BackendService.ListUserInvites:output_type -> tesseral.backend.v1.ListUserInvitesResponse
	73,  // 165: tesseral.backend.v1.BackendService.GetUserInvite:output_type -> tesseral.backend.v1.GetUserInviteResponse
	75,  // 166: tesseral.backend.v1.BackendService.CreateUserInvite:output_type -> tesseral.backend.v1.CreateUserInviteResponse
	77,  // 167: tesseral.backend.v1.BackendService.DeleteUserInvite:output_type -> tesseral.backend.v1.DeleteUserInviteResponse
	113, // 168: tesseral.backend.v1.BackendService.DisableOrganizationLogins:output_type -> tesseral.backend.v1.DisableOrganizationLoginsResponse
	115, // 169: tesseral.backend.v1.BackendService.DisableProjectLogins:output_type -> tesseral.backend.v1.DisableProjectLoginsResponse
	117, // 170: tesseral.backend.v1.BackendService.EnableOrganizationLogins:output_type -> tesseral.backend.v1.EnableOrganizationLoginsResponse
	119, // 171: tesseral.backend.v1.BackendService.EnableProjectLogins:output_type -> tesseral.backend.v1.EnableProjectLoginsResponse
	3,   // 172: tesseral.backend.v1.BackendService.UpdateProject:output_type -> tesseral.backend.v1.UpdateProjectResponse
	91,  // 173: tesseral.backend.v1.BackendService.GetVaultDomainSettings:output_type -> tesseral.backend.v1.GetVaultDomainSettingsResponse
	93,  // 174: tesseral.backend.v1.BackendService.UpdateVaultDomainSettings:output_type -> tesseral.backend.v1.UpdateVaultDomainSettingsResponse
	95,  // 175: tesseral.backend.v1.BackendService.EnableCustomVaultDomain:output_type -> tesseral.backend.v1.EnableCustomVaultDomainResponse
	97,  // 176: tesseral.backend.v1.BackendService.EnableEmailSendFromDomain:output_type -> tesseral.backend.v1.EnableEmailSendFromDomainResponse
	109, // 177: tesseral.backend.v1.BackendService.GetProjectUISettings:output_type -> tesseral.backend.v1.GetProjectUISettingsResponse
	111, // 178: tesseral.backend.v1.BackendService.UpdateProjectUISettings:output_type -> tesseral.backend.v1.UpdateProjectUISettingsResponse
	79,  // 179: tesseral.backend.v1.BackendService.ListBackendAPIKeys:output_type -> tesseral.backend.v1.ListBackendAPIKeysResponse
	81,  // 180: tesseral.backend.v1.BackendService.GetBackendAPIKey:output_type -> tesseral.backend.v1.GetBackendAPIKeyResponse
	83,  // 181: tesseral.backend.v1.BackendService.CreateBackendAPIKey:output_type -> tesseral.backend.v1.CreateBackendAPIKeyResponse
	85,  // 182: tesseral.backend.v1.BackendService.UpdateBackendAPIKey:output_type -> tesseral.backend.v1.UpdateBackendAPIKeyResponse
	87,  // 183: tesseral.backend.v1.BackendService.DeleteBackendAPIKey:output_type -> tesseral.backend.v1.DeleteBackendAPIKeyResponse
	89,  // 184: tesseral.backend.v1.BackendService.RevokeBackendAPIKey:output_type -> tesseral.backend.v1.RevokeBackendAPIKeyResponse
	99,  // 185: tesseral.backend.v1.BackendService.ListPublishableKeys:output_type -> tesseral.backend.v1.ListPublishableKeysResponse
	101, // 186: tesseral.backend.v1.BackendService.GetPublishableKey:output_type -> tesseral.backend.v1.GetPublishableKeyResponse
	103, // 187: tesseral.backend.v1.BackendService.CreatePublishableKey:output_type -> tesseral.backend.v1.CreatePublishableKeyResponse
	105, // 188: tesseral.backend.v1.BackendService.UpdatePublishableKey:output_type -> tesseral.backend.v1.UpdatePublishableKeyResponse
	107, // 189: tesseral.backend.v1.BackendService.DeletePublishableKey:output_type -> tesseral.backend.v1.DeletePublishableKeyResponse
	122, // 190: tesseral.backend.v1.BackendService.CreateUserImpersonationToken:output_type -> tesseral.backend.v1.CreateUserImpersonationTokenResponse
	124, // 191: tesseral.backend.v1.BackendService.CreateStripeCheckoutLink:output_type -> tesseral.backend.v1.CreateStripeCheckoutLinkResponse
