...
type AuditLogEvent struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// IDENTIFIER. The unique ID of the event.
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// REQUIRED. The ID of the parent organization.
	OrganizationId string `protobuf:"bytes,2,opt,name=organization_id,json=organizationId,proto3" json:"organization_id,omitempty"`
	...
	// INPUT ONLY. The credentials of the actor who performed the event.
	//
	// Either this or `actor` may be provided to identify the actor. If provided, this field
	// will not be returned on output.
	ActorCredentials string `protobuf:"bytes,5,opt,name=actor_credentials,json=actorCredentials,proto3" json:"actor_credentials,omitempty"`
	// The actor who performed the event.
	//
	// Actors must be either a User or API Key. To identify the actor, the credentials can
	// be provided via `actor_credentials` or one of `user_id`/`api_key_id` can be explicitly
	// provided.
	//
	// Types that are valid to be assigned to Actor:
	//
	//	*AuditLogEvent_UserId
	//	*AuditLogEvent_ApiKeyId
	Actor isAuditLogEvent_Actor `protobuf_oneof:"actor"`
	// REQUIRED. The event payload JSON.
...
func (x *AuditLogEvent) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *AuditLogEvent) GetActor() isAuditLogEvent_Actor {
	if x != nil {
		return x.Actor
	}
	return nil
...
func (x *AuditLogEvent) GetUserId() string {
	if x != nil {
		if x, ok := x.Actor.(*AuditLogEvent_UserId); ok {
			return x.UserId
		}
	}
	return ""
...
func (x *AuditLogEvent) GetApiKeyId() string {
	if x != nil {
		if x, ok := x.Actor.(*AuditLogEvent_ApiKeyId); ok {
			return x.ApiKeyId
		}
	}
	return ""
...
func (x *AuditLogEvent) GetDetails() *structpb.Struct {
	if x != nil {
		return x.Details
	}
	return nil
...
type isAuditLogEvent_Actor interface {
	isAuditLogEvent_Actor()
}

type AuditLogEvent_UserId struct {
...
type AuditLogEvent_ApiKeyId struct {
	// The ID of the API Key which performed the event.
	//
	// Actors must be either a User or API Key. To identify the actor, the credentials can
	// be provided via `actor_credentials` or one of `user_id`/`api_key_id` can be explicitly
	// provided.
	ApiKeyId string `protobuf:"bytes,7,opt,name=api_key_id,json=apiKeyId,proto3,oneof"`
}

func (*AuditLogEvent_UserId) isAuditLogEvent_Actor() {}

func (*AuditLogEvent_ApiKeyId) isAuditLogEvent_Actor() {}
...
var file_tesseral_backend_v1_models_proto_rawDesc = string([]byte{
	...
	0x64, 0x22, 0xba, 0x02, 0x0a, 0x0d, 0x41, 0x75, 0x64, 0x69, 0x74, 0x4c, 0x6f, 0x67, 0x45, 0x76,
	...
	,
...
var file_tesseral_backend_v1_models_proto_depIdxs = []int32{
	...
	25, // 34: tesseral.backend.v1.AuditLogEvent.timestamp:type_name -> google.protobuf.Timestamp
	26, // 35: tesseral.backend.v1.AuditLogEvent.details:type_name -> google.protobuf.Struct
...
func file_tesseral_backend_v1_models_proto_init() {
	...
	file_tesseral_backend_v1_models_proto_msgTypes[23].OneofWrappers = []any{
		(*AuditLogEvent_UserId)(nil),
		(*AuditLogEvent_ApiKeyId)(nil),
	}
	type x struct{}
