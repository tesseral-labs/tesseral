...
func RegisterIntermediateServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server IntermediateServiceServer) error {
	...
	mux.Handle("POST", pattern_IntermediateService_SignInWithEmail_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/intermediate.v1.IntermediateService/SignInWithEmail", runtime.WithHTTPPathPattern("/frontend/v1/email-signin"))
		if err != nil {
...
func RegisterIntermediateServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client IntermediateServiceClient) error {
	...
	mux.Handle("POST", pattern_IntermediateService_SignInWithEmail_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/intermediate.v1.IntermediateService/SignInWithEmail", runtime.WithHTTPPathPattern("/frontend/v1/email-signin"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_IntermediateService_SignInWithEmail_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"frontend", "v1", "email-signin"}, ""))
)
