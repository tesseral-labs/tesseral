-- not addressed in this design: what state do we have when someone is signing
-- up, but hasn't yet verified their email?
--
-- I think all of that stuff is associated with some sort of
-- "intermediary_session" table, which would keep track of your unverified
-- email.
...
(
    ...
    -- todo: do we support auto-verifying emails if they come from Google or Microsoft?
    --
    -- Auth0 doesn't: https://sec.okta.com/articles/2023/08/saying-no-thanks-noauth
