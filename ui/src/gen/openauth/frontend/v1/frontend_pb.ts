...
export type Organization = Message<"openauth.frontend.v1.Organization"> & {
  ...
  /**
   * @generated from field: bool saml_enabled = 10;
   */
  samlEnabled: boolean;

  /**
   * @generated from field: bool scim_enabled = 11;
   */
  scimEnabled: boolean;
};
