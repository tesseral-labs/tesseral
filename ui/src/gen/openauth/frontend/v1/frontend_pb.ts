...
export type Project = Message<"openauth.frontend.v1.Project"> & {
  ...
  /**
   * @generated from field: string custom_domain = 8;
   */
  customDomain: string;
};
