  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          API Keys to authenticate from your service.
        </CardDescription>
        <CardAction>
          <CreateApiKeyButton />
        </CardAction>
...
function CreateApiKeyButton() {
  ...
  async function handleSubmit(data: z.infer<typeof schema>) {
    ...
    if (apiKey) {
      ...
      await refetch();
      navigate(`/organization/api-keys/${apiKey.id}`);
    }
  }
    ...
    <>
      ...
      >
        <DialogContent>
          ...
          {apiKey?.secretToken && (
            <SecretCopier
              placeholder={`${project?.apiKeySecretTokenPrefix}•••••••••••••••••••••••••••••••••••••••••••••••••••••••`}
      ...
      <Dialog open={createOpen} onOpenChange={setCreateOpen}>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Create a new API Key for this organization. This key can be used
              to authenticate from your service.
            </DialogDescription>
          </DialogHeader>
  ...
  return (
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent>
          <DropdownMenuItem>
            <Link className="w-full" to={`/organization/api-keys/${apiKey.id}`}>
          ...
          <DropdownMenuItem>
            <Link
              className="w-full"
              to={`/organization/api-keys/${apiKey.id}/roles`}
            >
              <div className="w-full flex items-center gap-2">
                <GlobeLock />
                <span>Roles</span>
