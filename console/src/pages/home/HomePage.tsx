              ...
              <div>
                ...
                <CardContent className="text-sm">
                  ...
                  <p className="mt-4 text-muted-foreground">
                    ...
                    encounter issues with your implementation, please let us
                    know immediately. We want to get this right.
                  </p>
                  <p className="mt-4 text-muted-foreground">
                    This project is still in its early days. We're always
                    grateful to receive feedback from the community as we
