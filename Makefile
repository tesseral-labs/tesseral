...
.PHONY: proto
proto:
	rm -rf internal/backend/gen internal/frontend/gen internal/intermediate/gen internal/common/gen packages/common-ui/src/gen packages/console/src/gen packages/vault-ui/src/gen
